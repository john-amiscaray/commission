...
class BadCredentialsException(id: Long=-1): CommissionException("The user's credentials were found to be invalid for user with id: ${if(id == -1L) "unknown value" else id}")
